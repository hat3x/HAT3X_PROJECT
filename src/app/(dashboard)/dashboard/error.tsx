...
/**
 * Límite de error del panel. Presenta un estado claro y sereno con acción de
 * reintento (`reset`, provista por Next.js) y una salida secundaria. Debe ser
 * Client Component por requisito de los error boundaries de App Router.
 */
        ...
        <CardContent className="flex flex-col items-center gap-4 p-8">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-muted-foreground">
              Ha ocurrido un problema al preparar tu resumen. Puedes reintentar;
              si persiste, vuelve a intentarlo en unos minutos.
            </p>
          </div>
          ...
          <div className="mt-1 flex w-full flex-col gap-2 sm:flex-row sm:justify-center">
            ...
            <Button variant="outline" asChild>
              <Link href="/day-panel">Ir al panel del día</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
