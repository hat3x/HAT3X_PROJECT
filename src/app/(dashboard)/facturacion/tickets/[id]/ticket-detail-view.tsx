    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        {detail.lines.length === 0 ? (
          ...
          <div className="animate-fade-up overflow-hidden rounded-xl border bg-[var(--glass-panel)] backdrop-blur-xl backdrop-saturate-150 shadow-sm [animation-delay:80ms]">
