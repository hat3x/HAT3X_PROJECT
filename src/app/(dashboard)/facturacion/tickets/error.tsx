...
/**
 * Límite de error de Facturación → Tickets / Ventas. Si falla la carga del histórico
 * de ventas, presenta un estado claro y sereno con acción de reintento (`reset`,
 * provista por Next.js). Debe ser Client Component por requisito de los error
 * boundaries del App Router.
 */
      ...
      <CardContent className="flex flex-col items-center gap-4 p-8">
        ...
        <div className="space-y-1.5">
          <h2 className="text-xl font-semibold tracking-tight">
            No hemos podido cargar las ventas
          </h2>
          <p className="text-sm text-muted-foreground">
            Ha ocurrido un problema al preparar el histórico de tickets y ventas.
            Puedes reintentar; si persiste, vuelve a intentarlo en unos minutos.
          </p>
        </div>
