  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          // Radio consistente (rounded-lg), sombra interior sutil y transición
          // suave (150ms) de color/borde/sombra. El borde se tiñe de marca al
          // pasar el cursor para reforzar la afordancia sin cambiar la altura.
