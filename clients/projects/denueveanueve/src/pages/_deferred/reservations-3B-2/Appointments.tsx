...
// NOTE (sub-7): RescheduleDialog was co-archived here for sub-phase 3B-2.
// When restoring, either keep this relative import or move RescheduleDialog
// back to src/components/ and switch to '@/components/RescheduleDialog'.
