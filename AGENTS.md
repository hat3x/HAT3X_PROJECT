...
| `code-review` | Code review experto, security checklist | [alirezarezvani/Codex-skills](https://github.com/alirezarezvani/Codex-skills) |
| `security-audit` | OWASP Top 10, scanner seguridad | [alirezarezvani/Codex-skills](https://github.com/alirezarezvani/Codex-skills) |
| `api-design` | REST best practices, Zod validation | [alirezarezvani/Codex-skills](https://github.com/alirezarezvani/Codex-skills) |
| `documentation` | README, technical writing, maintenance | [alirezarezvani/Codex-skills](https://github.com/alirezarezvani/Codex-skills) |
| `mcp-servers` | MCP ecosystem, herramientas externas | [subinium/awesome-Codex](https://github.com/subinium/awesome-Codex) |
| `agile-workflow` | Scrum, sprints, user stories | [levnikolaevich/Codex-skills](https://github.com/levnikolaevich/Codex-skills) |
